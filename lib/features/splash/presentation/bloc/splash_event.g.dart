...
class _$TokenNeedRefresh extends TokenNeedRefresh {
  ...
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is TokenNeedRefresh;
  }
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper(r'TokenNeedRefresh').toString();
  }
}

class TokenNeedRefreshBuilder
    implements Builder<TokenNeedRefresh, TokenNeedRefreshBuilder> {
  _$TokenNeedRefresh? _$v;

  TokenNeedRefreshBuilder();
  ...
  @override
  void update(void Function(TokenNeedRefreshBuilder)? updates) {
    if (updates != null) updates(this);
  }
...
class _$RefreshToken extends RefreshToken {
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper(r'RefreshToken').toString();
  }
}
